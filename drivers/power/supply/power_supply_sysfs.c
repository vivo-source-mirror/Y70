...
static const char * const power_supply_health_text[] = {
	...
	"Safety timer expire",
	"Warm", "Cool", "Hot",
	"Dual-engine"/* @vivo add for Dual-engine */, "Vivo Super Flash Charge"
};
...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(camera4k_state),
	POWER_SUPPLY_ATTR(camera_charge_close),
	POWER_SUPPLY_ATTR(flashled_state),
	...
	/* FlashCharge end */
	POWER_SUPPLY_ATTR(loader_switch_counter),
	POWER_SUPPLY_ATTR(keep_chg_soc),
	POWER_SUPPLY_ATTR(bsptest_start_chg_soc),
	POWER_SUPPLY_ATTR(bsptest_stop_chg_soc),
	POWER_SUPPLY_ATTR(charging_technology),
	/* vivo add end */
