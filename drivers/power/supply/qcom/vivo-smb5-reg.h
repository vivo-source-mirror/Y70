...
#define CHARGER_ERROR_STATUS_SFT_EXPIRE_BIT		BIT(2) /*vivo add*/
...
#define CHGR_SAFETY_TIMER_ENABLE_CFG_MASK	GENMASK(1, 0)
#define PRE_CHARGE_SAFETY_TIMER_EN_BIT		BIT(1)
...
#define ICL_IMIN_BIT				BIT(2) /*vivo add*/
...
#define VSYSMIN_3P2_V			0x3

#define DCDC_VPH_TRACK_SEL_REG		(DCDC_BASE + 0x89)
#define VPH_TRACK_SEL_MASK			GENMASK(1, 0)
#define VPH_TRACK_SEL_100MV			0x0
/*vivo end*/
...
#define TYPE_C_DEBUG_ACCESS_SNK_CFG		(TYPEC_BASE + 0x4A)
#define DAM_SEL_ICL_3A_OR_FMB		BIT(2)
...
#define AICL_RERUN_TIME_45S_VAL			0x2 /*vivo add*/
