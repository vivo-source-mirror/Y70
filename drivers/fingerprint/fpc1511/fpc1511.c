...
static const struct vreg_config vreg_conf[] = {
	{ "vdd_ana", 1800000UL, 1800000UL, 8000, },
};
...
#ifdef FPC_USE_PLAT_POWER_SUPPLY

		rc = vreg_setup(fpc1020, "vdd_ana", true);
		if (rc)
			goto exit;
#else
		rc = select_pin_ctl(fpc1020, "fpc1020_vdd_high");
		if (rc)
			goto exit;
#endif
...
#else
		(void)select_pin_ctl(fpc1020, "fpc1020_vdd_low");
#endif
exit:
