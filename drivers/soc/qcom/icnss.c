...
static int cnss_fw_ready;
module_param(cnss_fw_ready, int, 0644);
MODULE_PARM_DESC(wcnss_ready, "Added by Huangxinyun");
...
static int icnss_driver_event_fw_ready_ind(void *data)
{
	...
	cnss_fw_ready = 1;  //for factory test. Added by huangxinyuan
