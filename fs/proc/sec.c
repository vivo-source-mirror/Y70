...
#define SEC_ENABLE_REG_ADDR         0x01B40458

#define SEC_ROOT_CERT_HASH_ADDR     0x01B40228
#define SEC_MASK_BIT_56             0XFFFFFFFFFFFFFF00
#define SEC_MASK_BIT_32             0XFFFFFFFF00000000
#define SEC_RPMB_KEY_PROVISION_ADDR 0x01B40218 
#define SEC_ANTI_ROLLBACK_ENABLE_ADDR 0x01B401CC   
...
static int  get_secureboot_root_cert_hash(void __iomem *key_hash_addr, char *hash, const int size)
{
	...
	for (i = 0; i < 4; i++) {
		...
		strlcat(hash, hex_str, sizeof(hex_str));
		reg_addr += 8;
	}
	return 1;
}
