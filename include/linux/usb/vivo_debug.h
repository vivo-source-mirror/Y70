...
#define dev_emerg(dev, fmt, ...) dev_emerg(dev, USB_DEBUG_TAG fmt, ##__VA_ARGS__)
#define dev_alert(dev, fmt, ...) dev_alert(dev, USB_DEBUG_TAG fmt, ##__VA_ARGS__)
#define dev_crit(dev, fmt, ...) dev_crit(dev, USB_DEBUG_TAG fmt, ##__VA_ARGS__)
#define dev_err(dev, fmt, ...) dev_err(dev, USB_DEBUG_TAG fmt, ##__VA_ARGS__)
#define dev_warn(dev, fmt, ...) dev_warn(dev, USB_DEBUG_TAG fmt, ##__VA_ARGS__)
#define dev_notice(dev, fmt, ...) dev_notice(dev, USB_DEBUG_TAG fmt, ##__VA_ARGS__)
