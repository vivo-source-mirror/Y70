...
enum {
	...
	POWER_SUPPLY_HEALTH_DUAL_ENGINE,	//QC2.0 /Vivo Low voltage Dchg(5V/4.5A) /Vivo High voltage chg(10V/2.25A)
	/* @vivo add for VIVO super Flash Charge (VFCP=vivo flash charger protocol)*/
	POWER_SUPPLY_HEALTH_VIVO_SUPER_FLASH_CHARGE,	//Vivo High voltage chg(10V/4A) /Vivo High voltage chg(10V/5A) /Vivo High voltage chg(10V/6A)
};
...
/*FOR:usb_det_pin_mode,detect id irq*/
enum _usb_det_pin_mode_ {
	USB_DET_PIN_MODE_NONE = 0,/*non-support*/
	USB_DET_PIN_MODE_DET,
	USB_DET_PIN_MODE_IDLE,
	USB_DET_PIN_MODE_INVALID,
	USB_DET_PIN_MODE_FORCE,
};
...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_CAMERA_CHARGE_CLOSE,
	...
	POWER_SUPPLY_PROP_POLLING_FG_ERROR,
	...
	/* vivo extensions of type for no user node*/
	...
	POWER_SUPPLY_PROP_CHARGE_TERM_CURRENT_DELTA,
	...
	POWER_SUPPLY_PROP_USB_CONN_PROTECT,
	POWER_SUPPLY_PROP_BATT_ID_DETECT_DONE,
	POWER_SUPPLY_PROP_OTG_VBUS_ENABLE,
	POWER_SUPPLY_PROP_USB_TEMPORARY_PRESENT,
	/*bq fg*/
	...
	POWER_SUPPLY_PROP_HW_JEITA_DISABLE,
...
enum power_supply_typec_power_role {
	...
	/*vivo add*/
	POWER_SUPPLY_TYPEC_PR_DELTA,
	POWER_SUPPLY_TYPEC_PR_DUAL_VIVO,
	POWER_SUPPLY_TYPEC_PR_SINK_VIVO,
	POWER_SUPPLY_TYPEC_PR_SOURCE_VIVO,
};
