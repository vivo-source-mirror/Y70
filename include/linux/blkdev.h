...
#define HW_TIMEOUT_THRES	(2000000000ULL) /* 2s */
#define BLK_TIMEOUT_THRES	(2000000000ULL) /* 2s */
#define CMD_TIMEOUT_THRES	(300000000ULL) /* 300ms */
#endif
...
#ifdef CONFIG_BLOCK_TIMEOUT_WARNING
	unsigned long long		blk_start_time;
	unsigned long long		hw_start_time;
	unsigned long long		cmd_start_time;
#endif
};
...
#ifdef CONFIG_BLOCK_TIMEOUT_WARNING
	unsigned long long		blk_timeout_threshold;
	unsigned long long		hw_timeout_threshold;
	unsigned long long		cmd_timeout_threshold;
#endif
...
#ifdef CONFIG_BLOCK_TIMEOUT_WARNING
static inline void set_hw_start_time_ns(struct request *req)
{
	preempt_disable();
	req->hw_start_time = sched_clock();
	preempt_enable();
}

static inline void set_blk_start_time_ns(struct request *req)
{
	preempt_disable();
	req->blk_start_time = sched_clock();
	preempt_enable();
}

static inline void set_cmd_start_time_ns(struct request *req)
{
	preempt_disable();
	req->cmd_start_time = sched_clock();
	preempt_enable();
}
#endif
